    ...
    $('.reference a').on('click', function (e) {
        ...
        if (images.length > 0) {
            ...
            for (var i = 0; i < images.length; ++i) {
                sliderContent = sliderContent + '<div class="item"><img src=' + images[i] + ' alt="" ></div>';
            }
        } else {
            sliderContent = sliderContent + '<div class="item"><iframe src="" width="640" height="480"></iframe></div>';
        }
